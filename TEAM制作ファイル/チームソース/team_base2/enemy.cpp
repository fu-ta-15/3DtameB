...
void EnemyPos(void)
{
	...
	if (pStage->nStageNum == 0)
	{
		...
		SetEnemy(D3DXVECTOR3(0, 0.0f, 400), ENEMYTYPE_ROBOT001);
		SetEnemy(D3DXVECTOR3(0, 0.0f, -400), ENEMYTYPE_ROBOT001);
	}
	else if (pStage->nStageNum == 1)
	{
		//SetEnemy(D3DXVECTOR3(400, 0.0f, -400), ENEMYTYPE_ROBOT000);
		SetEnemy(D3DXVECTOR3(-400, 0.0f, -400), ENEMYTYPE_ROBOT000);
		SetEnemy(D3DXVECTOR3(0, 0.0f, -400), ENEMYTYPE_ROBOT001);
		SetEnemy(D3DXVECTOR3(0, 0.0f, 400), ENEMYTYPE_ROBOT000);
		SetEnemy(D3DXVECTOR3(-400, 0.0f, -400), ENEMYTYPE_ROBOT001);
	}
	else if (pStage->nStageNum == 2)
	{
		SetEnemy(D3DXVECTOR3(0, 0.0f, -400), ENEMYTYPE_ROBOT000);
		SetEnemy(D3DXVECTOR3(0, 0.0f, -400), ENEMYTYPE_ROBOT000);
		SetEnemy(D3DXVECTOR3(0, 0.0f, -400), ENEMYTYPE_ROBOT001);
