...
// マクロ定義
//=============================================================================
#define MAX_SIZE (300.0f)							//フィールドサイズ
...
HRESULT InitMeshfield(void)
{
	...
	pVtx[2].tex = D3DXVECTOR2(4.0f, 0.0f);
	pVtx[3].tex = D3DXVECTOR2(0.0f, 2.0f);
	pVtx[4].tex = D3DXVECTOR2(2.0f, 2.0f);
	pVtx[5].tex = D3DXVECTOR2(4.0f, 2.0f);
	pVtx[6].tex = D3DXVECTOR2(0.0f, 4.0f);
	pVtx[7].tex = D3DXVECTOR2(2.0f, 4.0f);
	pVtx[8].tex = D3DXVECTOR2(4.0f, 4.0f);
