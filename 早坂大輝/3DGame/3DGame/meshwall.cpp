...
HRESULT InitMeshwall(void)
{
	...
	// 壁の設定
	SetMeshwall(D3DXVECTOR3(0.0f, 0.0f, WALL_SIZE), D3DXVECTOR3(0.0f, 0.0f, 0.0f), WALL_SIZE, 50.0f);
	SetMeshwall(D3DXVECTOR3(0.0f, 0.0f, 100.0f), D3DXVECTOR3(0.0f, D3DX_PI / 2, 0.0f), WALL_SIZE, 50.0f);
	SetMeshwall(D3DXVECTOR3(0.0f, 0.0f, 100.0f), D3DXVECTOR3(0.0f, D3DX_PI / -2, 0.0f), WALL_SIZE, 50.0f);
	SetMeshwall(D3DXVECTOR3(0.0f, 0.0f, 100.0f), D3DXVECTOR3(0.0f, D3DX_PI, 0.0f), WALL_SIZE, 50.0f);
