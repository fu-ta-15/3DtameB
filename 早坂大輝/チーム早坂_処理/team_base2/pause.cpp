...
HRESULT InitPause(void)
{
	...
	D3DXCreateTextureFromFile(pDevice, "data/TEXTURE/pause.png", &g_pTexturePause[1]);
	D3DXCreateTextureFromFile(pDevice, "data/TEXTURE/CONTINUE.png", &g_pTexturePause[2]);
	D3DXCreateTextureFromFile(pDevice, "data/TEXTURE/retry.png", &g_pTexturePause[3]);
	D3DXCreateTextureFromFile(pDevice, "data/TEXTURE/quit.png", &g_pTexturePause[4]);
...
void SetTexturePause(int nCntPause)
{
	...
	{
		//頂点座標
		pVtx[0].pos = D3DXVECTOR3(620, 1050, 0.0f);	//Zは0.0固定
		pVtx[1].pos = D3DXVECTOR3(620, 50, 0.0f);
		pVtx[2].pos = D3DXVECTOR3(1300, 1050, 0.0f);
		pVtx[3].pos = D3DXVECTOR3(1300, 50, 0.0f);

		//カラー
		PauseCol[nCntPause] = D3DXCOLOR(1.0f, 1.0f, 1.0f, 0.6f);
	}
	...
	{
		//頂点座標
		pVtx[0].pos = D3DXVECTOR3(720, 675, 0.0f);	//Zは0.0固定
		pVtx[1].pos = D3DXVECTOR3(720, 525, 0.0f);
		pVtx[2].pos = D3DXVECTOR3(1200, 675, 0.0f);
		pVtx[3].pos = D3DXVECTOR3(1200, 525, 0.0f);
	...
	{
		//頂点座標
		pVtx[0].pos = D3DXVECTOR3(720, 950, 0.0f);	//Zは0.0固定
		pVtx[1].pos = D3DXVECTOR3(720, 800, 0.0f);
		pVtx[2].pos = D3DXVECTOR3(1200, 950, 0.0f);
		pVtx[3].pos = D3DXVECTOR3(1200, 800, 0.0f);
